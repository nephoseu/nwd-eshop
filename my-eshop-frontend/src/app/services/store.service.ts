...
export class StoreService {
  ...
  private readonly _shippings = new BehaviorSubject<Shipping[]>([]);
  readonly shippings$ = this._shippings.asObservable(); 
  
  get shippings(): Shipping[] {
    return this._shippings.getValue();
  }

  set shippings(val: Shipping[]) {
    this._shippings.next(val);
  }
